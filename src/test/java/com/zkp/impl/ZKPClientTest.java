...
public class ZKPClientTest {
  ...
  public void setUp() throws Exception {
    ...
    // Create a ZKPClient using the in-process channel;
    client = new ZKPClient(channel);
  }
